...
#ifndef POLARITONIC_RKS_H
#define POLARITONIC_RKS_H
...
class PolaritonicRKS: public PolaritonicHF {

  public:

    PolaritonicRKS(std::shared_ptr<Wavefunction> reference_wavefunction,Options & options);
