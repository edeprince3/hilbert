...
namespace hilbert {
    ...
    public:
         ...
         * @return the effective dipole operator as a TArrayMap
         */
        TArrayMap effective_dipole();
    ...
    protected:
        ...
        void resid_21_1(), resid_21_2(), resid_21_3(), resid_21_4();
