...
#ifndef CC_CAVITY_QED_CCSDT_H
#define CC_CAVITY_QED_CCSDT_H
...
namespace hilbert {
    ...
    class QED_CCSDT : public QED_CCSD {

    public:
        QED_CCSDT(const shared_ptr<Wavefunction> &reference_wavefunction, Options & options);
        ~QED_CCSDT() override = default;
