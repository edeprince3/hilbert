...
#ifndef HILBERT_EOM_EE_QED_CCSD_H
#define HILBERT_EOM_EE_QED_CCSD_H
...
namespace hilbert {
    ...
    public:
        EOM_EE_QED_CCSD(const shared_ptr<CC_Cavity> &cc_wfn, Options & options);
...
#endif //HILBERT_EOM_EE_QED_CCSD_H
