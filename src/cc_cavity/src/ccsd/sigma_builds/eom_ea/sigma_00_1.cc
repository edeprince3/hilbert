...
void hilbert::EOM_EA_CCSD::sigma_ea_00_1() {
    ...
    // flops: o0v1L1  = o0v1L1 o1v2L1 o1v2L1 o1v3L1 o0v1L1 o0v2L1 o0v1L1 o1v3L1 o0v1L1 o0v1L1 o0v1L1 o0v2L1 o0v1L1 o0v2L1 o0v1L1
    //  mems: o0v1L1  = o0v1L1 o0v1L1 o0v1L1 o0v1L1 o0v1L1 o0v1L1 o0v1L1 o0v1L1 o0v1L1 o0v1L1 o0v1L1 o0v1L1 o0v1L1 o0v1L1 o0v1L1
    tmps_["1_b_Lv"]("R,a")  = -1.00 * scalars_["1"] * r1["b"]("R,a");
    tmps_["1_b_Lv"]("R,a") -= 2.00 * f["aa_ov"]("k,d") * r2["aba"]("R,d,a,k");
    tmps_["1_b_Lv"]("R,a") -= 2.00 * f["bb_ov"]("j,b") * r2["bbb"]("R,b,a,j");
    tmps_["1_b_Lv"]("R,a") += eri["bbbb_vovv"]("a,j,b,c") * r2["bbb"]("R,b,c,j");
    tmps_["1_b_Lv"]("R,a") += r1["b"]("R,c") * reused_["2_bb_vv"]("a,c");
    tmps_["1_b_Lv"]("R,a") += 2.00 * eri["baab_vovv"]("a,k,d,c") * r2["aba"]("R,d,c,k");
    tmps_["1_b_Lv"]("R,a") -= 2.00 * r1["b"]("R,c") * reused_["1_bb_vv"]("c,a");
    tmps_["1_b_Lv"]("R,a") += 2.00 * f["bb_vv"]("a,b") * r1["b"]("R,b");

    // sigmar1_b  = -0.50 <i,a||b,c>_bbbb r2_bbb(b,c,i)
    //           += -1.00 f_bb(i,b) r2_bbb(b,a,i)
    //           += -0.50 <j,i||b,c>_bbbb r1_b(c) t2_bbbb(b,a,j,i)
    //           += -0.50 <i,a||b,c>_abab r2_aba(b,c,i)
    //           += -0.50 <i,a||c,b>_abab r2_aba(c,b,i)
    //           += -1.00 f_aa(i,b) r2_aba(b,a,i)
    //           += -0.50 <j,i||j,i>_bbbb r1_b(a)
    //           += -0.50 <j,i||j,i>_aaaa r1_b(a)
    //           += -0.50 <j,i||j,i>_abab r1_b(a)
    //           += -0.50 <i,j||i,j>_abab r1_b(a)
    //           += +0.25 <j,i||b,c>_bbbb r1_b(a) t2_bbbb(b,c,j,i)
    //           += +0.25 <j,i||b,c>_abab r1_b(a) t2_abab(b,c,j,i)
    //           += +0.25 <i,j||b,c>_abab r1_b(a) t2_abab(b,c,i,j)
    //           += +0.25 <j,i||c,b>_abab r1_b(a) t2_abab(c,b,j,i)
    //           += +0.25 <i,j||c,b>_abab r1_b(a) t2_abab(c,b,i,j)
    //           += +1.00 f_bb(i,i) r1_b(a)
    //           += +0.25 <j,i||b,c>_aaaa r1_b(a) t2_aaaa(b,c,j,i)
    //           += +1.00 f_aa(i,i) r1_b(a)
    //           += -0.50 <j,i||b,c>_abab r1_b(c) t2_abab(b,a,j,i)
    //           += -0.50 <i,j||b,c>_abab r1_b(c) t2_abab(b,a,i,j)
    //           += +1.00 f_bb(a,b) r1_b(b)
    sigmar1_b("R,a")  = 0.50 * tmps_["1_b_Lv"]("R,a");
    tmps_["1_b_Lv"].~TArrayD();

    // flops: o0v1L1  = o0v2L1
    //  mems: o0v1L1  = o0v1L1
    tmps_["2_b_Lv"]("R,a")  = 2.00 * f["bb_vv"]("a,b") * r1["b"]("R,b");
    tmps_["2_b_Lv"].~TArrayD();

    // flops: o0v1L1  = o0v1L1 o1v2L1 o0v2L1 o1v3L1 o0v2L1 o0v1L1 o1v3L1 o0v1L1 o1v2L1 o0v1L1 o0v1L1 o0v1L1 o0v1L1 o0v2L1 o0v1L1
    //  mems: o0v1L1  = o0v1L1 o0v1L1 o0v1L1 o0v1L1 o0v1L1 o0v1L1 o0v1L1 o0v1L1 o0v1L1 o0v1L1 o0v1L1 o0v1L1 o0v1L1 o0v1L1 o0v1L1
    tmps_["3_a_Lv"]("R,a")  = -1.00 * scalars_["1"] * r1["a"]("R,a");
    tmps_["3_a_Lv"]("R,a") -= 2.00 * f["aa_ov"]("i,b") * r2["aaa"]("R,b,a,i");
    tmps_["3_a_Lv"]("R,a") -= 2.00 * r1["a"]("R,c") * reused_["4_aa_vv"]("a,c");
    tmps_["3_a_Lv"]("R,a") += 2.00 * eri["abab_vovv"]("a,j,b,e") * r2["abb"]("R,b,e,j");
    tmps_["3_a_Lv"]("R,a") += r1["a"]("R,c") * reused_["3_aa_vv"]("a,c");
    tmps_["3_a_Lv"]("R,a") += eri["aaaa_vovv"]("a,i,b,c") * r2["aaa"]("R,b,c,i");
    tmps_["3_a_Lv"]("R,a") += 2.00 * f["bb_ov"]("j,d") * r2["abb"]("R,a,d,j");
    tmps_["3_a_Lv"]("R,a") += 2.00 * f["aa_vv"]("a,b") * r1["a"]("R,b");

    // sigmar1_a  = -0.50 <j,i||b,c>_aaaa r1_a(c) t2_aaaa(b,a,j,i)
    ...
    sigmar1_a("R,a")  = 0.50 * tmps_["3_a_Lv"]("R,a");
    tmps_["3_a_Lv"].~TArrayD();

    // flops: o0v1L1  = o1v3L1
    //  mems: o0v1L1  = o0v1L1
    tmps_["6_a_Lv"]("L,a")  = -4.00 * l2["bab"]("L,i,b,c") * reused_["9_baab_vvvo"]("c,a,b,i");

    // flops: o0v1L1  = o0v2L1
    //  mems: o0v1L1  = o0v1L1
    tmps_["4_a_Lv"]("R,a")  = 2.00 * f["aa_vv"]("a,b") * r1["a"]("R,b");
    ...
    // flops: o0v1L1  = o1v3 o1v3 o1v3L1 o1v3L1 o0v1L1 o1v3L1 o0v1L1 o0v2L1 o0v1L1 o1v2L1 o0v1L1 o1v2L1 o0v1L1 o1v2L1 o0v1L1 o1v2L1 o0v1L1 o1v3L1 o0v1L1 o0v1L1 o0v1L1 o1v3L1 o0v1L1 o1v3L1 o0v1L1 o0v2L1 o0v1L1 o0v2L1 o0v1L1 o0v1L1 o1v1L1 o0v1L1
    ...
    tmps_["7_a_Lv"]("L,a")  = -0.50 * (4.00 * reused_["5_aaaa_vovv"]("c,j,b,a") + reused_["10_aaaa_vovv"]("a,j,b,c") + 2.00 * eri["aaaa_vvvo"]("c,b,a,j")) * l2["aaa"]("L,j,b,c");
    tmps_["7_a_Lv"]("L,a") += 2.00 * eri["abab_vvvo"]("b,d,a,k") * l2["bab"]("L,k,b,d");
    tmps_["7_a_Lv"]("L,a") += 2.00 * l2["bab"]("L,k,b,d") * reused_["7_aabb_vvvo"]("b,a,d,k");
    tmps_["7_a_Lv"]("L,a") -= 2.00 * l1["a"]("L,c") * reused_["4_aa_vv"]("c,a");
    tmps_["7_a_Lv"]("L,a") += 2.00 * l2["bab"]("L,k,a,d") * reused_["14_bb_vo"]("d,k");
    tmps_["7_a_Lv"]("L,a") -= 2.00 * f["aa_vo"]("c,j") * l2["aaa"]("L,j,c,a");
    tmps_["7_a_Lv"]("L,a") += 2.00 * f["bb_vo"]("d,k") * l2["bab"]("L,k,a,d");
    tmps_["7_a_Lv"]("L,a") -= l2["aaa"]("L,j,c,a") * reused_["13_aa_ov"]("j,c");
    tmps_["7_a_Lv"]("L,a") -= 2.00 * l2["bab"]("L,k,b,d") * reused_["8_aabb_vvvo"]("b,a,d,k");
    tmps_["7_a_Lv"]("L,a") -= scalars_["1"] * l1["a"]("L,a");
    tmps_["7_a_Lv"]("L,a") += 2.00 * l2["bab"]("L,k,b,d") * reused_["11_abab_vovv"]("a,k,b,d");
    tmps_["7_a_Lv"]("L,a") += 2.00 * l2["aaa"]("L,j,b,c") * reused_["6_aaaa_vvvo"]("b,a,c,j");
    tmps_["7_a_Lv"]("L,a") += 2.00 * f["aa_vv"]("c,a") * l1["a"]("L,c");
    tmps_["7_a_Lv"]("L,a") -= l1["a"]("L,c") * reused_["12_aa_vv"]("a,c");
    tmps_["7_a_Lv"]("L,a") -= 0.50 * tmps_["6_a_Lv"]("L,a");
    tmps_["7_a_Lv"]("L,a") += f["aa_ov"]("i,a") * tmps_["5_a_Lo"]("L,i");
    ...
    sigmal1_a("L,a")  = 0.50 * tmps_["7_a_Lv"]("L,a");
    tmps_["7_a_Lv"].~TArrayD();

    // flops: o1v0L1  = o2v2L1 o2v2L1 o1v1L1 o1v0L1 o1v0L1
    //  mems: o1v0L1  = o1v0L1 o1v0L1 o1v0L1 o1v0L1 o1v0L1
    tmps_["12_a_Lo"]("R,i")  = 0.50 * eri["aaaa_oovv"]("i,k,a,c") * r2["aaa"]("R,a,c,k");
    tmps_["12_a_Lo"]("R,i") += eri["abab_oovv"]("i,j,a,b") * r2["abb"]("R,a,b,j");
    tmps_["12_a_Lo"]("R,i") += f["aa_ov"]("i,a") * r1["a"]("R,a");
}