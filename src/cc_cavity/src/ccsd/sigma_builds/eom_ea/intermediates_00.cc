...
void hilbert::EOM_EA_CCSD::build_common_ops() {
    ...
    {
        reused_["1_aa_vv"]("a,b")  = t2["aaaa"]("c,a,i,j") * eri["aaaa_oovv"]("j,i,c,b");
        reused_["2_aa_vv"]("a,b")  = t2["abab"]("a,c,i,j") * eri["abab_oovv"]("i,j,b,c");
        reused_["3_aaaa_vovv"]("a,i,b,c")  = t2["aaaa"]("d,a,i,j") * eri["aaaa_vovv"]("b,j,c,d");
        reused_["4_aaaa_vvvo"]("a,b,c,i")  = eri["abab_vovv"]("a,j,b,d") * t2["abab"]("c,d,i,j");
        reused_["5_aabb_vvvo"]("a,b,c,i")  = eri["aaaa_vovv"]("a,j,b,d") * t2["abab"]("d,c,j,i");
        reused_["6_aabb_vvvo"]("a,b,c,i")  = eri["abab_vovv"]("a,j,b,d") * t2["bbbb"]("d,c,i,j");
        reused_["7_baab_vvvo"]("a,b,c,i")  = eri["baab_vovv"]("a,j,b,d") * t2["abab"]("c,d,j,i");
        reused_["8_aaaa_vovv"]("a,i,b,c")  = eri["aaaa_oovo"]("j,k,a,i") * t2["aaaa"]("b,c,k,j");
        reused_["9_abab_vovv"]("a,i,b,c")  = eri["abab_oovo"]("j,k,a,i") * t2["abab"]("b,c,j,k");
        reused_["10_aa_vv"]("a,b")  = eri["aaaa_oovv"]("i,j,a,c") * t2["aaaa"]("c,b,j,i");
        reused_["11_aa_ov"]("i,a")  = -2.00 * f["aa_ov"]("l,c") * t2["aaaa"]("c,a,i,l");
        reused_["11_aa_ov"]("i,a") += 2.00 * eri["abab_vovv"]("a,j,c,e") * t2["abab"]("c,e,i,j");
        reused_["11_aa_ov"]("i,a") += eri["aaaa_oovo"]("l,k,c,i") * t2["aaaa"]("c,a,k,l");
        reused_["11_aa_ov"]("i,a") += eri["aaaa_vovv"]("a,l,c,d") * t2["aaaa"]("c,d,i,l");
        reused_["11_aa_ov"]("i,a") += 2.00 * eri["abba_oovo"]("k,j,b,i") * t2["abab"]("a,b,k,j");
        reused_["11_aa_ov"]("i,a") += 2.00 * f["bb_ov"]("j,b") * t2["abab"]("a,b,i,j");
        reused_["12_bb_vo"]("a,i")  = -1.00 * eri["baab_vovv"]("a,j,b,c") * t2["abab"]("b,c,j,i");
        reused_["12_bb_vo"]("a,i") -= f["bb_ov"]("k,d") * t2["bbbb"]("d,a,i,k");
        reused_["12_bb_vo"]("a,i") -= t2["abab"]("b,a,m,k") * eri["abab_oovo"]("m,k,b,i");
        reused_["12_bb_vo"]("a,i") += 0.50 * eri["bbbb_vovv"]("a,k,d,c") * t2["bbbb"]("d,c,i,k");
        reused_["12_bb_vo"]("a,i") += f["aa_ov"]("j,b") * t2["abab"]("b,a,j,i");
        reused_["12_bb_vo"]("a,i") += 0.50 * eri["bbbb_oovo"]("k,l,d,i") * t2["bbbb"]("d,a,l,k");
        reused_["13_aabb_vvvo"]("a,b,c,i")  = eri["aaaa_vovv"]("a,j,d,b") * t2["abab"]("d,c,j,i");
        reused_["14_bbaa_voov"]("a,i,j,b")  = t2["abab"]("c,a,k,i") * eri["aaaa_oovv"]("k,j,c,b");
        reused_["15_bbbb_voov"]("a,i,j,b")  = t2["bbbb"]("c,a,i,k") * eri["bbbb_oovv"]("k,j,c,b");
        reused_["16_bb_vv"]("a,b")  = t2["bbbb"]("c,a,i,j") * eri["bbbb_oovv"]("j,i,c,b");
        reused_["17_bb_oo"]("i,j")  = t2["bbbb"]("a,b,i,k") * eri["bbbb_oovv"]("k,j,a,b");
        reused_["18_bbbb_voov"]("a,i,j,b")  = t2["abab"]("c,a,k,i") * eri["abab_oovv"]("k,j,c,b");
        reused_["19_bbaa_voov"]("a,i,j,b")  = t2["bbbb"]("c,a,i,k") * eri["abab_oovv"]("j,k,b,c");
        reused_["20_bb_vv"]("a,b")  = eri["abab_oovv"]("i,j,c,a") * t2["abab"]("c,b,i,j");
        reused_["21_bb_oo"]("i,j")  = t2["abab"]("a,b,k,i") * eri["abab_oovv"]("k,j,a,b");
        reused_["22_aaaa_vvvo"]("a,b,c,i")  = eri["aaaa_vovv"]("a,j,d,b") * t2["aaaa"]("d,c,i,j");
        reused_["23_aaaa_voov"]("a,i,j,b")  = t2["aaaa"]("c,a,i,k") * eri["aaaa_oovv"]("k,j,c,b");
        reused_["24_aabb_voov"]("a,i,j,b")  = t2["abab"]("a,c,i,k") * eri["bbbb_oovv"]("k,j,c,b");
        reused_["25_aabb_voov"]("a,i,j,b")  = t2["aaaa"]("c,a,i,k") * eri["abab_oovv"]("k,j,c,b");
        reused_["26_aa_oo"]("i,j")  = eri["aaaa_oovv"]("i,k,a,b") * t2["aaaa"]("a,b,j,k");
        reused_["27_aa_oo"]("i,j")  = t2["abab"]("a,b,i,k") * eri["abab_oovv"]("j,k,a,b");
        reused_["28_aa_oo"]("i,j")  = t2["aaaa"]("a,b,i,k") * eri["aaaa_oovv"]("k,j,a,b");
        reused_["29_aaaa_voov"]("a,i,j,b")  = t2["aaaa"]("c,a,i,k") * eri["aaaa_oovv"]("j,k,b,c");
        reused_["30_bbaa_voov"]("a,i,j,b")  = t2["abab"]("c,a,k,i") * eri["aaaa_oovv"]("j,k,b,c");
        reused_["31_aabb_voov"]("a,i,j,b")  = t2["abab"]("a,c,i,k") * eri["bbbb_oovv"]("j,k,b,c");
        reused_["32_bbbb_voov"]("a,i,j,b")  = t2["bbbb"]("c,a,i,k") * eri["bbbb_oovv"]("j,k,b,c");
        reused_["33_bb_vv"]("a,b")  = eri["bbbb_oovv"]("i,j,a,c") * t2["bbbb"]("c,b,j,i");
        reused_["34_bb_oo"]("i,j")  = eri["bbbb_oovv"]("i,k,a,b") * t2["bbbb"]("a,b,j,k");
    }
