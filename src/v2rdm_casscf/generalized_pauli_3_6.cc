...
void v2RDMSolver::Generalized_Pauli_3_6_constraints_ATu(SharedVector A,SharedVector u){
...
void v2RDMSolver::Generalized_Pauli_3_6_constraints_Au(SharedVector A,SharedVector u){
    ...
    // l4 - l5 - l6 <= 0
    A_p[offset++] = u_p[ gpcoff[3] ] + l4 - l5 - l6;
